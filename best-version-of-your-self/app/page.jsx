      ...
      <Background>
          ...
          >
            <Carousel.Slide>
              <div className="relative bg-banner-2 bg-cover bg-center h-[600px]">
                ...
                <p
                  className="relative px-10 pt-20 md:leading-tight 
            ...
            <Carousel.Slide>
              <div className="relative bg-banner-3 bg-cover bg-center h-[600px]">
                <div className="absolute inset-0 bg-black opacity-30" />
                <p
                  className="relative px-10 pt-20 text-6xl
        ...
        <div className="flex justify-between w-full bg-green-800 py-2 px-4 fixed bottom-6 bg-opacity-90 rounded-t-xl">
          ...
          <div className="flex gap-2">
            <Link type="button" href="/login" className="green_btn">
              Log In
            </Link>
            <Link type="button" href="/signup" className="outline_btn">
              Sign Up
            </Link>
          </div>
        </div>
